...
export const fetchTicketsFromAPI = async (id) => {
    ...
    const response = await axios.get(`http://18.209.26.169:8080/api/customers/${id}/tickets`, {
        headers: { 
...
export const raiseTicketFromAPI = async (ticketData) => {
    ...
    try{
        const response = await axios.post(`http://18.209.26.169:8080/api/customers/${userName}/tickets`, ticketData, {
            headers: {
